    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $page_title === 'Products' ? 'active' : '' ?>" aria-current="page" href="<?= url_for('dashboard/products.php') ?>">Products</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $page_title === 'Orders' ? 'active' : '' ?>" aria-current="page" href="<?= url_for('dashboard/orders.php') ?>">Orders</a>
                </li>
